...
static_thresholds   = {
        "cpu": 0.7,    # Example: 70% CPU usage as threshold
        "rtt": 100.0,  # Example: 100ms RTT as threshold
        "plr": 0.05    # Example: 5% packet loss rate as threshold
    }
...
try:
        # Run simulation
        results, injector, data_returned, history, tendency_data = run_complete_simulation(default_weights, baseline_values, max_values, steps=10, seed=10, fault_templates='fault_injection/fault_templates_zero.yaml')
